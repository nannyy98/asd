...
class WebhookManager:
    ...
    def handle_stripe_webhook(self, payload):
        ...
        try:
            ...
            print(f"Ошибка обработки Stripe webhook: {e}")
            return {'status': 'error'}
    ...
    def handle_paypal_webhook(self, payload):
        ...
        try:
            ...
            print(f"Ошибка обработки PayPal webhook: {e}")
            return {'status': 'error'}
    ...
    def log_webhook_success(self, provider, order_id, user_id):
        ...
        try:
            ...
            print(f"Ошибка записи лога webhook: {e}")
    ...
    def log_webhook_error(self, provider, error_message, payload_preview):
        ...
        try:
            ...
            print(f"Ошибка записи лога ошибки webhook: {e}")